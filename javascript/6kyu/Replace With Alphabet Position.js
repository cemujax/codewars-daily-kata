 ...
 * @date    : 2019. 01. 27
 * @url     : https://www.codewars.com/kata/replace-with-alphabet-position/train/javascript
 *
 */

const alphabetPosition = text => {
  const letter = text.toUpperCase().match(/[a-z]/gi) || [];
  return letter.map(ch => ch.charCodeAt() - 64).join(" ");
};
